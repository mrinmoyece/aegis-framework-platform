...
has no enabled credentialed connector/model provider or production effect. The operator
BFF is deterministic fake-only and production readiness fails closed without live OIDC
exchange and durable sessions.
